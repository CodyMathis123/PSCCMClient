...
namespace PSCCMClient.Core.Services
{
    ...
    public class CCMClientActionService : CCMServiceBase, ICCMClientActionService
    {
        ...
        /// <summary>
        /// Creates a new CCMClientActionService with credential support
        /// </summary>
        ...
        public CCMClientActionService(string computerName, string username, SecureString password, string? domain = null) 
