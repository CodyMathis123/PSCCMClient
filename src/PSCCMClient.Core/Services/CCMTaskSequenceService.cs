...
namespace PSCCMClient.Core.Services
{
    ...
    public class CCMTaskSequenceService : CCMServiceBase, ICCMTaskSequenceService
    {
        ...
        /// <summary>
        /// Creates a new CCMTaskSequenceService with credential support
        /// </summary>
        ...
        public CCMTaskSequenceService(string computerName, string username, SecureString password, string? domain = null) 
